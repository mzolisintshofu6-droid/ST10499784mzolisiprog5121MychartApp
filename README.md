...
- The program will prompt you to enter a username, password, and phone number for registration.
  
- Once registration is successful, you will be prompted to log in with your credentials.
